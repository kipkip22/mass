$(document).ready(function() {
	...
	// Primer mensaje
	var msjs1 = [
		'Hey, ich bin heute einsam, brauche jemanden, der mich zu Hause begleitet <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(6).jpg"/>',
	];
	var msj1 = msjs1[Math.floor(Math.random()*msjs1.length)];
	// Segundo mensaje
	var msjs2 = [
		'Machen Sie dort ein neues Profil und ich rufe Sie dort an Baby <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(3).jpg"/>',
	];
	var msj2 = msjs2[Math.floor(Math.random()*msjs2.length)];
	// Tercer mensaje
	var msjs3 = [
		'Hast du mein Video gesehen? <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(1).jpg" style="margin-left:0"/> <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(1).jpg"/>',
	];
	var msj3 = msjs3[Math.floor(Math.random()*msjs3.length)];
	// Mensaje final
	var msjsf = [
		'Wenn Sie schon drinnen sind, schicken Sie mir Ihren Namen auf meiner Website, ich werde Sie anrufen <img class="emj" src="http://rotterlik.16mb.com/img/emoji/res%20(2).jpg"/>',
	];
